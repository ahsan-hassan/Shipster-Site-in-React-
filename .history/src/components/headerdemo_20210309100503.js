    ...
    <div className="dropdown" style={{ height: '400px'}} ref={dropdownRef}>
      ...
      <CSSTransition
        ...
        <div className="menu">
          ...
          <DropdownItem
            ...
            goToMenu="profile">
            Profile
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '228px'}}/>
          </DropdownItem>
          ...
          <DropdownItem
            ...
            goToMenu="home">
            Home
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '229px'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
            ...
            Order History
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '182px'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
            goToMenu="Contact Us">
            Contact Us
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '195px'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
      ...
      <CSSTransition
        ...
        <div className="menu">
          ...
          <RiArrowLeftSLine style={{color:'black' , width:'25px' , height:'40px' , marginBottom: '15px'}}/>
          </DropdownItem>
          <hr></hr>
      ...
      <CSSTransition
        ...
        <div className="menu">
          <DropdownItem goToMenu="main" leftIcon={<ArrowIcon />}>
          <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginBottom: '15px'}}/>
          </DropdownItem>
          <hr></hr>
