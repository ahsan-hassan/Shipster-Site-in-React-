    ...
    <div className="dropdown" style={{ height: '400px'}} ref={dropdownRef}>
      ...
      <CSSTransition
        ...
        <div className="menu">
          ...
          <DropdownItem
            ...
            goToMenu="profile">
            Profile
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '253px',color:'#0660A5'}}/>
          </DropdownItem>
          ...
          <DropdownItem
            ...
            goToMenu="home">
            Home
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '255px', color:'#0660A5'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
            ...
            Order History
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '209px', color:'#0660A5'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
            goToMenu="Contact Us">
            Contact Us
            <RiArrowRightSLine style={{color:'black' , width:'25px' , height:'40px' , marginLeft: '222px', color:'#0660A5'}}/>
          </DropdownItem>
          <hr></hr>
          <DropdownItem
            rightIcon={<ChevronIcon />}
      ...
      <CSSTransition
        ...
        <div className="menu">
          ...
          <RiArrowLeftSLine style={{color:'black' , width:'25px' , height:'40px' ,color:'#0660A5'}}/>
          </DropdownItem>
          <hr></hr>
