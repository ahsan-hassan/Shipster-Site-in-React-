    ...
    render() {
        return (
            <div>
                ...
                <Card style={{ width: '22rem' , marginLeft:'15px', height: '17rem' , borderRadius: '15px' , alignItems: 'center', boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
