            ...
            <div>
                ...
                <Form className="orderform" >
                    <Form.Group controlId="formBasicAddress" className="form_group">
                        ...
                        <Form.Text>Give permanent Home Address</Form.Text>
                    </Form.Group>

                    <Form.Group controlId="formBasicAddress" className="form_group">
                        <Form.Label>Dropoff Location</Form.Label>
                        <Form.Control type="address" />
                        <Form.Text>Give permanent Dropoff Location</Form.Text>
                    </Form.Group>
                    ...
                    <Form.Group controlId="formBasicCheckbox" className="form_group" className="abc">
