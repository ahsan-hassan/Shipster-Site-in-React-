              ...
              <div className='track_page'>
                   ...
                   {items.map(item => (
                      <Col sm={12} lg={4} md={6}><li className='track_page_li'>  
                           ...
                           <Button href="/pages/OrderSummary" id={item._id} onClick={() => this.reply_click(item._id)} style={{backgroundColor:'white' , color:'#0660A5', width: '145px', marginLeft: '90px'}} >More Details</Button>
                       </li>
                       </Col> 
                   ))}
               </Row>
