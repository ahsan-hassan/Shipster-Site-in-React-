        ...
        return (
            <div>
              ...
              <div className='track_page'>
                   ...
                   <Row> 
                   {items.map(item => (
                      <Col sm={3} lg={12} md={4}><li className='track_page_li'>  
                           <li style={{marginLeft: '15px'}}><h5>ID:</h5>{item._id}</li> 
                           <li style={{marginLeft: '15px'}}>{item.pickUpContact}</li> 
                           <li style={{marginLeft: '15px'}}>{item.pickUpName} </li><br></br>
                           <Button style={{backgroundColor:'white' , color:'#0660A5', width: '145px', marginLeft: '90px'}}>More Details</Button>
                       </li>
                       </Col> 
                   ))}
