    ...
    render() {
        return (
            <div>
                ...
                <Button variant="primary" type="submit" style={{marginBottom: '30px', marginLight: '300px', width: '130px' }}>
                        Submit
                </Button>
                <Button variant="primary" type="submit" style={{marginBottom: '30px', marginRight: '300px', width: '130px'}}>
                        Submit
                </Button>
                </Row>
                </div>
