    ...
    render() {
        return (
            <div>
                ...
                <div>
                <Button variant="primary" type="submit" style={{marginBottom: '30px',marginRight: '30px' , width: '130px' }}>
                        Edit
                </Button>
                <Button variant="primary" type="submit" style={{marginBottom: '30px', width: '130px'}}>
                        Confirm
                </Button>
                </div>
                </Row>
